function myready() {
	...
	$(".game_class a").click(function() {
		window.location.href = "/stsa/libsetauto?gid=" + $(this).attr('gid');
	});
	...
	$(".send").click(function() {
		...
		$(".nr").each(function() {
			...
			if (i > 0) str += ',';
			str += '"' + i + '":{"ifok":"' + ifok + '","ifzc":"' + ifzc + '","ftype":"' + ftype +
				'","startje":"' + startje + '","startpeilv":"' + startpeilv + '","addje":"' + addje +
				'","attpeilv":"' + attpeilv + '","lowpeilv":"' + lowpeilv + '","stopje":"' + stopje +
				'","yj":"' + yj + '","qsnum":"' + qsnum + '","qspeilv":"' + qspeilv + '"}';
			if (startje % 1 != 0 | addje % 1 != 0 | stopje % 1 != 0 | qsnum % 1 != 0) err1 = true;
			if ((startpeilv * 10000) % 1 != 0 | (attpeilv * 10000) % 1 != 0 | (lowpeilv * 10000) % 1 !=
				0 | (qspeilv * 10000) % 1 != 0) err2 = true;
