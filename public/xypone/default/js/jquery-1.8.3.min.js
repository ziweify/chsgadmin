...
/*$(function () {
    if (js == 1) {
        $.ajax({
            type: 'POST', url: mulu + 'myscript.php', cache: false, data: 'sf=' + sss, success: function (m) {
                $("#myjs").append(eval(eval(m)));
                m = null;
                myready();
            }
        });
...
function bofang(SOUND_URL) {
    if(localStorage.getItem("resultBellFlag") == null || localStorage.getItem("resultBellFlag") == "true"){
        SOUND_URL = "/xypone/default/js/" + SOUND_URL + ".mp3";
        if (!SOUND_URL) {
            return
        }
        var a = $("#SOUND");
