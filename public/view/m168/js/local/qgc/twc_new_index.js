...
$(function () {
    pubmethod.initAdata(), method.indexLoad(boxId), ifishad = !0, $("#startVideo").on("touchstart", function () {
...
method.loadOther = function (t) {
    ...
    var t = "#" + $(t).attr("id"),
        i = {url: config.publicUrl + "taiWanCai/getLotteryInfo.do", id: boxId, lotCode: lotCode};
    config.ifdebug, headMethod.loadHeadData(i), method.loadOther("")
