...
function formatDate(e) {
    ...
    a = a < 10 ? "0" + a : a;
    var r = e.getDate();
    return r = r < 10 ? "0" + r : r, t + "-" + a + "-" + r
}

function creatDataHead(e, t) {
    publicmethod.insertHeadSsC(e, t), tools.setTimefun_ssc()
}
...
$(function () {
    $("#headdivbox").load("../public/head.html", function () {
        ...
        config.ifdebug
    }), tools.showExplain(), tools.playVideo_SSC(), $(".listheadrl span").live("click", function () {
...
var urlbublic = config.publicUrl, lotCode = lotCode.sgssc, boxid = "#cqSsc", indexObj = new Object, datajson = null;
