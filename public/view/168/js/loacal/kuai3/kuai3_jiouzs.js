...
function yilouFc() {
    ...
    for (var a = $("#" + s + " tbody tr[class='yiloutr']"), e = a.length, i = a.filter(":first").children("td").size(), n = 2; n < i; n++) for (var h = 0; h <= e; h++) {
        var o = a.eq(h).children("td").eq(n);
        if ("0" == o.attr("title")) break;
        o.addClass("yiloufc")
    }
}
...
function doCheck(t, s) {
    ...
    var h = 0, o = $("." + t + "  .item_" + s + " .lz_table_con td:first-child p:last ");
    o.css("font-weight", "bold");
    var l = setTimeout(function () {
        o.fadeOut(100).fadeIn(100), 1 == ++h && (l = setInterval(arguments.callee, 600)), 30 == h && window.clearInterval(l)
    }, 1e3)
}
...
function listData() {
    ...
    $.ajax({
        url: urlbublic + "lotteryJSFastThree/queryOddAndEvenTrend.do?date=" + t + "&issue=" + s + "&periods=" + a,
        type: "GET",
...
function forRank(t) {
    ...
    $("#table_weizhi tbody").empty(), $(t).each(function (t) {
        $(this.bodyList).each(function (t) {
            ...
            var i = "<td>" + a + "</td>", n = "", h = "", o = "", l = "", c = "", r = "", d = "", f = "", u = "",
                m = "", b = "", p = "", g = "";
            $(this.numberDistribution).each(function (t) {
                ...
                l > 1 && (o = "<i class = ''>" + l + "</i>"), n += "<td " + h + " " + s + "><span " + a + ">" + i + "</span>" + o + "</td>"
            }), $(this.hundredForm).each(function (t) {
                var s = "", a = "", e = "";
                0 == t ? (1 * this > 0 ? (s = "title='0'", a = "style='background:" + color[1] + "'", e = "奇") : (s = "class='yilou'", e = Math.abs(this)), h += "<td " + i + " " + s + "><span " + a + ">" + e + "</span></td>") : 1 == t && (1 * this > 0 ? (s = "title='0'", a = "style='background:" + color[1] + "'", e = "偶") : (s = "class='yilou'", e = Math.abs(this)), o += "<td " + i + " " + s + "><span " + a + ">" + e + "</span></td>");
                var i = "";
                t < 7 && (i = "style='background-color:#fcf9f2'")
            }), $(this.tenForm).each(function (t) {
                var s = "", a = "", e = "";
                0 == t ? (1 * this > 0 ? (s = "title='0'", a = "style='background:" + color[1] + "'", e = "奇") : (s = "class='yilou'", e = Math.abs(this)), l += "<td " + i + " " + s + "><span " + a + ">" + e + "</span></td>") : 1 == t && (1 * this > 0 ? (s = "title='0'", a = "style='background:" + color[1] + "'", e = "偶") : (s = "class='yilou'", e = Math.abs(this)), c += "<td " + i + " " + s + "><span " + a + ">" + e + "</span></td>");
                var i = "";
                t < 7 && (i = "style='background-color:#fcf9f2'")
            }), $(this.unitForm).each(function (t) {
                var s = "", a = "", e = "";
                0 == t ? (1 * this > 0 ? (s = "title='0'", a = "style='background:" + color[1] + "'", e = "奇") : (s = "class='yilou'", e = Math.abs(this)), r += "<td " + i + " " + s + "><span " + a + ">" + e + "</span></td>") : 1 == t && (1 * this > 0 ? (s = "title='0'", a = "style='background:" + color[1] + "'", e = "偶") : (s = "class='yilou'", e = Math.abs(this)), d += "<td " + i + " " + s + "><span " + a + ">" + e + "</span></td>");
                var i = "";
                t < 7 && (i = "style='background-color:#fcf9f2'")
            }), $(this.oddEvenCompare).each(function (t) {
                var s = "", a = "", e = "";
                ...
                var i = "";
                t < 7 && (i = "style='background-color:#fcf9f2'")
            }), $(this.oddNumber).each(function (t) {
                var s = "", a = "", e = "";
            ...
            }), $(this.evenNumber).each(function (t) {
                var s = "", a = "", e = "";
                1 * this >= 0 ? (s = "title='0'", a = "style='background:" + color[1] + "'", e = 6 == t ? "大" : 7 == t ? "小" : 8 == t ? "单" : 9 == t ? "双" : Math.abs(this)) : (e = Math.abs(this), s = "class='yilou'");
                var i = "";
                t < 7 && (i = "style='background-color:#fcf9f2'"), g += "<td " + i + " " + s + "><span " + a + ">" + e + "</span></td>"
            });
            var v = "<tr class='yiloutr'>" + s + i + n + h + o + l + c + r + d + f + u + m + b + p + g + "</tr>";
            $("#table_weizhi tbody").append(v)
        });
        $("#table_weizhi tbody").append('<tr><th rowspan="2" colspan="2" width="85" height="38" class="left_border left_b left_strong_down">数据统计</th><th colspan="6" width="40">开奖号码分布</th><th colspan="2" width="40">百位</th><th colspan="2" width="40">十位</th><th colspan="2" width="40">个位</th><th colspan="4" width="40">奇偶比走势</th><th colspan="4" width="40">奇数个数</th><th colspan="4" width="40">偶数个数</th></tr><tr><th width="40" class="font14">1</th><th width="40" class="font14">2</th><th width="40" class="font14">3</th><th width="40" class="font14">4</th><th width="40" class="font14">5</th><th width="40" class="font14">6</th><th width="40" class="font14">奇</th><th width="40" class="font14">偶</th><th width="40" class="font14">奇</th><th width="40" class="font14">偶</th><th width="40" class="font14">奇</th><th width="40" class="font14">偶</th><th width="40" class="font14">3:0</th><th width="40" class="font14">2:1</th><th width="40" class="font14">1:2</th><th width="40" class="font14">0:3</th><th width="40" class="font14">0</th><th width="40" class="font14">1</th><th width="40" class="font14">2</th><th width="40" class="font14">3</th><th width="40" class="font14">0</th><th width="40" class="font14">1</th><th width="40" class="font14">2</th><th width="40" class="font14">3</th></tr>');
