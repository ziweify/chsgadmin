...
function loadotherData(t) {
    listData(t), todayData(), longData()
}

function listData(t) {
    t = void 0 == t ? "" : t, $.ajax({
        url: urlbublic + "CQShiCai/queryHistoryDataForDsdx.do",
        type: "GET",
...
function longData() {
    $.ajax({
        url: urlbublic + "CQShiCai/getCQShiCaiDailyDragon.do",
        type: "GET",
        data: {lotCode: lotCode},
        success: function (t) {
            loadLongData(t)
...
function loadLongData(t) {
    ...
    for (var e = 0, s = data.length; e < s; e++) {
        var a = minci(data[e].rank, "rank"), i = minci(data[e].state, "state"),
            ...
            d = "<li>第<span>" + a + "</span>名：&nbsp;&nbsp;<span>" + i + "</span>&nbsp;&nbsp;" + l + "期</li>";
...
function createHtmlList(t) {
    ...
    $("#dsdxlstable tbody").empty(), $(e).each(function (t) {
        var e = $(this)[0],
            s = "<tr height='38'>" + ("<td width='100'>" + e.date + "</td>") + ("<td >" + e.list[0].bigCount + "</td><td >" + e.list[0].smallCount + "</td><td >" + e.list[0].singleCount + "</td><td >" + e.list[0].doubleCount + "</td>") + ("<td>" + e.list[1].bigCount + "</td><td>" + e.list[1].smallCount + "</td><td>" + e.list[1].singleCount + "</td><td>" + e.list[1].doubleCount + "</td>") + ("<td >" + e.list[2].bigCount + "</td><td >" + e.list[2].smallCount + "</td><td >" + e.list[2].singleCount + "</td><td >" + e.list[2].doubleCount + "</td>") + ("<td>" + e.list[3].bigCount + "</td><td>" + e.list[3].smallCount + "</td><td>" + e.list[3].singleCount + "</td><td>" + e.list[3].doubleCount + "</td>") + ("<td >" + e.list[4].bigCount + "</td><td >" + e.list[4].smallCount + "</td><td >" + e.list[4].singleCount + "</td><td >" + e.list[4].doubleCount + "</td>") + "</tr>";
        $("#dsdxlstable tbody").append(s)
    })
}
...
$(function () {
    ...
    $("#gotop").click(function () {
        ...
        trigger: ".date", zIndex: 999, format: "yyyy-mm-dd", onSelected: function (t, e, s) {
            ...
            checkseletime(a), loadotherData(e), l = [], $("#chakanchfb,#daxiaodsfb").find("li").removeClass("selected"), config.ifdebug
...
$(".listheadrl span").live("click", function () {
    ...
    var t = $(this).attr("id"), e = $("#biaozxz .sinli:nth-child(4)"), s = $("#biaozxz .sinli:nth-child(5)");
    e.hasClass("checked") && e.removeClass("checked"), s.hasClass("checked") && s.removeClass("checked"), tabarr = [], $("#chakanchfb,#daxiaodsfb").find("li").removeClass("selected"), "today" == t ? loadotherData(getDateStr(0), "") : "yesterday" == t ? loadotherData(getDateStr(-1), "") : "qianday" == t ? loadotherData(getDateStr(-2), "") : "thirty" == t ? loadotherData("", "30") : "sixty" == t ? loadotherData("", "60") : "ninety" == t && loadotherData("", "90")
});