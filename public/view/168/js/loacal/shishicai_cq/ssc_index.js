...
function listData() {
    $.ajax({
        ...
        success: function (e) {
            createHtmlList(e), tools.resetListColor(), animateMethod.loadingList("#jrsmhmtj", !1)
        },
        error: function (e) {
            setTimeout(function () {
                loadotherData()
...
function loadTodayData(e) {
    ...
    var t = $("#shuanmiandata");
    $(t).find(".cs0").text(data.numZero), $(t).find(".cs1").text(data.numOne), $(t).find(".cs2").text(data.numTwo), $(t).find(".cs3").text(data.numThree), $(t).find(".cs4").text(data.numFour), $(t).find(".cs5").text(data.numFive), $(t).find(".cs6").text(data.numSix), $(t).find(".cs7").text(data.numSeven), $(t).find(".cs8").text(data.numEight), $(t).find(".cs9").text(data.numNine);
    var s = $("#gylhcs");
...
function createHtmlList(e) {
    ...
    $("#jrsmhmtj>table").empty(), $("#jrsmhmtj>table").html('<tr><th width="150">时间</th><th width="130">期数</th><th id="numberbtn" class="numberbtn"><span id="xshm" class="spanselect">显示号码</span><span id="xsdx">显示大小</span><span id="xsds">显示单双</span></th><th colspan="3">总和</th><th colspan="5">1-5龙虎</th></tr>'), $(t).each(function (e) {
        ...
        if (a.length <= 1) i = "<td class='blueqiu'></td>"; else {
            var i = "<td class='blueqiu'><ul style='width:240px'>" + s + "</ul></td>", l = "style='color:",
                n = "0" == this.sumSingleDouble ? "单" : "双", d = "双" == n ? l + "#f12d35'" : "'",
                r = "0" == this.sumBigSmall ? "大" : "小", c = "大" == r ? l + "#f12d35'" : "'",
                o = typeOf("lhh", this.dragonTiger);
            if ("龙" == o) u = l + "#f12d35'"; else if ("和" == o) u = l + "#00ab07 !important'"; else var u = "'"
        }
        var h = "<tr>" + t + i + ("<td>" + this.sumNum + "</td><td " + d + ">" + n + "</td><td " + c + ">" + r + "</td><td " + u + ">" + o + "</td>") + "</tr>";
...
$(function () {
    ...
    $("#daxiaodsfb").delegate("li", "click", function () {
        ...
        t.hasClass("selected") || t.trigger("click");
        ...
        $(this).attr("id");
        $(this).siblings().removeClass("spanselect"), $(this).hasClass("spanselect") ? $(this).removeClass() : $(this).addClass("spanselect"), tools.bigOrSmall($(this).attr("id"), 5)
