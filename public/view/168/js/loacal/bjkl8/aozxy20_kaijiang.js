...
var boxid = "#klsf", urlbublic = config.publicUrl, pathObj = window.location.pathname.split("/"),
    lotcodePath = pathObj[pathObj.length - 2], lotCode = getParameterByName("code"), indexObj = new Object;
function typeOf(e, t) {
...
$(function () {
    ...
    $("#headdivbox").load("../public/head.html", function () {
        ...
        config.ifdebug
    }), tools.playVideo_BJKL8(), $(".listheadrl span").live("click", function () {
