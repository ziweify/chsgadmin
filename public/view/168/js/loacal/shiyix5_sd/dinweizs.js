...
function doCheck(t, s) {
    ...
    var c = 0, l = $("." + t + "  .item_" + s + " .lz_table_con td:first-child p:last ");
    l.css("font-weight", "bold");
    var o = setTimeout(function () {
        l.fadeOut(100).fadeIn(100), 1 == ++c && (o = setInterval(arguments.callee, 600)), 30 == c && window.clearInterval(o)
    }, 1e3)
}
...
function listData() {
    ...
    $.ajax({
        url: urlbublic + "ElevenFive/queryElevnFiveLocalTrend.do?num=" + s + "&issue=" + e + "&date=" + t,
        type: "GET",
...
function checkNum() {
    var t = $("#biaozxz").find("li[class='sinli selected']").find("span").text();
    ...
    $("#table_weizhi tbody").empty(), $(t).each(function (t) {
        $(this.bodyList).each(function (t) {
            ...
            $(this.array).each(function (t) {
                var s = "", e = "", a = "";
                1 * this >= 0 ? (s = "title='0'", e = "style='background:" + color[1] + "'", a = 11 == t ? "大" : 12 == t ? "小" : 13 == t ? "和" : 14 == t ? "单" : 15 == t ? "双" : 16 == t ? "和" : 17 == t ? "0" : 18 == t ? "1" : 19 == t ? "2" : 20 == t ? "升" : 21 == t ? "平" : 22 == t ? "降" : Math.abs(this)) : (a = Math.abs(this), s = "class='yilou'");
                var i = "";
                t < 11 && (i = "style='background-color:#fcf9f2'"), n += "<td " + i + " " + s + "><span " + e + ">" + a + "</span></td>"
            });
            var c = "<tr class='yiloutr'>" + s + i + n + "</tr>";
            $("#table_weizhi tbody").append(c)
        });
        var s = $("#chartbottom table tbody").html();
        $("#table_weizhi tbody").append(s);
        var e = "<td class='font14' colspan='2'>出现次数</td>", a = "<td class='font14' colspan='2'>平均遗漏</td>",
            i = "<td class='font14' colspan='2'>最大遗漏</td>", n = "<td class='font14' colspan='2'>最大连出</td>",
            c = "<td class='font14' colspan='2'>当前遗漏</td>";
        $(this.missList).each(function (t) {
            0 == t ? $(this.array).each(function () {
                ...
                c += "<td class='font14'>" + Math.abs(this) + "</td>"
            })
        }), $("#table_weizhi tbody").append("<tr>" + e + "</tr><tr>" + a + "</tr><tr>" + i + "</tr><tr>" + n + "</tr><tr style='display: none'>" + c + "</tr>")
