...
function tongjiCount(t) {
    var e = $(t), s = e.parent().find(".txtNum").val(), a = e.parent().find(".secType").val(),
        l = e.parent().parent().find(".ifds").text(), n = "";
    "单双" == l ? 1 == a ? n = "单" : 0 == a ? n = "双" : 2 == a && (n = "和") : "大小" == l ? 1 == a ? n = "大" : 0 == a ? n = "小" : 2 == a && (n = "和") : "龙虎" == l ? n = 1 == a ? "龙" : "虎" : "尾大尾小" == l ? n = 1 == a ? "大" : "小" : "合单合双" == l ? n = 1 == a ? "单" : "双" : "中发白" == l ? 2 == a ? n = "中" : 3 == a ? n = "发" : 4 == a && (n = "白") : "东南西北" == l && (5 == a ? n = "东" : 6 == a ? n = "南" : 7 == a ? n = "西" : 8 == a && (n = "北")), e.parent().parent().parent().parent().parent().find(".tablebox").html();
    var i = 0;
    ...
    }), e.parent().parent().find(".sec_count").text(i)
}

function doCheck(t, e) {
    var s = $("." + t + "  .item_" + e + " .lz_table_head td .txtNum").val(),
        a = $("." + t + "  .item_" + e + " .lz_table_head td .secType").val(), l = Number("0" + s), n = 0;
    $("." + t + "  .item_" + e + " .lz_table_con td").each(function () {
        $(this).removeClass("shaw"), $(this).children("p").html() == a && $(this).children("p").length >= l && ($(this).removeAttr("style"), $(this).addClass("shaw"), n++)
    ...
    var i = 0, c = $("." + t + "  .item_" + e + " .lz_table_con td:first-child p:last ");
    c.css("font-weight", "bold");
    var o = setTimeout(function () {
        c.fadeOut(100).fadeIn(100), 1 == ++i && (o = setInterval(arguments.callee, 600)), 30 == i && window.clearInterval(o)
    }, 1e3)
}
...
function listData(t) {
    var t = void 0 == t ? "" : t;
    $.ajax({
        url: urlbublic + "ElevenFive/queryComprehensiveRoadBead.do?date=" + t,
        type: "GET",
...
function loadLongData(t) {
    ...
    for (var e = 0, s = data.length; e < s; e++) {
        var a = minci(data[e].rank, "rank"), l = minci(data[e].state, "state"),
            ...
            i = "<li>第<span>" + a + "</span>名：&nbsp;&nbsp;<span>" + l + "</span>&nbsp;&nbsp;" + n + "期</li>";
        11 != data[e].rank && 1 != data[e].rank && 2 != data[e].rank || (i = "<li><span>" + a + "</span>：&nbsp;&nbsp;<span>" + l + "</span>&nbsp;&nbsp;" + n + "期</li>"), $("#cltxul").append(i)
    }
}
...
function zhmsMcMethod(t, e) {
    ...
    if ("all" == t) (zhmssxmc = []).length >= 10 || $($("#zhms").find(".sinli")).each(function (t) {
        ...
        if (config.ifdebug, s.removeClass("hoverli"), s.hasClass("checked")) {
            ...
            for (var l = 0, n = zhmssxmc.length; l < n; l++) zhmssxmc[l] == a && zhmssxmc.splice(l, 1)
        } else if (s.addClass("hoverli"), s.addClass("checked"), zhmssxmc.length <= 0) zhmssxmc.push(a); else {
            for (var l = 0, n = zhmssxmc.length; l < n && zhmssxmc[l] != a; l++) ;
            zhmssxmc.push(a)
        }
        config.ifdebug
    }
...
function zhmsLzMethod(t, e) {
    if ("all" == t) (zhmssxlz = []).length >= 10 || $($("#zhms .zhmslz").find(".lztype")).each(function (t) {
        ...
        if (s.removeClass("hoverli"), s.hasClass("checked")) {
            s.removeClass("checked");
            for (var l = 0, n = zhmssxlz.length; l < n; l++) zhmssxlz[l] == a && zhmssxlz.splice(l, 1)
        } else if (s.addClass("hoverli"), s.addClass("checked"), zhmssxlz.length <= 0) zhmssxlz.push(a); else {
            for (var l = 0, n = zhmssxlz.length; l < n && zhmssxlz[l] != a; l++) ;
            zhmssxlz.push(a)
        }
        config.ifdebug
    }
...
function dxmsLzMethod(t, e) {
    if ("all" != t) {
        ...
        if (config.ifdebug, s.removeClass("hoverli"), s.hasClass("checked")) {
            s.removeClass("checked");
            for (var l = 0, n = dxmssxlz.length; l < n; l++) dxmssxlz[l] == a && dxmssxlz.splice(l, 1)
        } else if (s.addClass("hoverli"), s.addClass("checked"), dxmssxlz.length <= 0) dxmssxlz.push(a); else {
            for (var l = 0, n = dxmssxlz.length; l < n && dxmssxlz[l] != a; l++) ;
            dxmssxlz.push(a)
        }
        "dmchexkall" == t && (dxmssxlz = [], $("#dxms ul .lztype").each(function () {
            dxmssxlz.push($(this).find("i").text())
        })), config.ifdebug, excuteZhmsSelect(dxmssxmc, dxmssxlz)
    } else $("#dxms .lztype").each(function (t) {
...
function lmmsMcMethod(t, e) {
    ...
    if (s.removeClass("hoverli"), "all" == t) (lmmssxmc = []).length >= 10 || $($("#lmms").find(".sinli")).each(function (t) {
        ...
        if (s.hasClass("checked")) {
            s.removeClass("checked");
            for (var l = 0, n = lmmssxmc.length; l < n; l++) lmmssxmc[l] == a && lmmssxmc.splice(l, 1)
        } else if (s.addClass("hoverli"), s.addClass("checked"), lmmssxmc.length <= 0) lmmssxmc.push(a); else {
            for (var l = 0, n = lmmssxmc.length; l < n && lmmssxmc[l] != a; l++) ;
            lmmssxmc.push(a)
        }
    }
...
function excuteZhmsSelect(t, e) {
    for (var s = [], a = 0, l = t.length; a < l; a++) for (var n = 0, i = e.length; n < i; n++) t[a], s.push(t[a] + "" + e[n]);
...
function forRank(t, e) {
    ...
    "6" == e.state ? (s.find(".z_count").text(e.totals[0]), s.find(".f_count").text(e.totals[1]), s.find(".b_count").text(e.totals[2]), s.find(".h_count").text(e.totals[1])) : "7" == e.state ? (s.find(".d_count").text(e.totals[0]), s.find(".n_count").text(e.totals[1]), s.find(".x_count").text(e.totals[2]), s.find(".b_count").text(e.totals[3])) : "3" == e.state ? (s.find(".right_count").text(e.totals[2]), s.find(".left_count").text(e.totals[0]), s.find(".h_count").text(e.totals[1])) : "2" == e.state ? (s.find(".left_count").text(e.totals[0]), s.find(".right_count").text(e.totals[1]), s.find(".h_count").text(e.totals[2])) : (s.find(".left_count").text(e.totals[1]), s.find(".right_count").text(e.totals[0]), s.find(".h_count").text(e.totals[2]));
    var a = typeOf("qiu1", e.rank);
    "6" == e.rank ? a = "总和" : "7" == e.rank && (a = "和尾"), s.find(".ifgj").text(a), s.find(".ifds").text(typeOf("state", e.state));
    var l = "";
    s.find(".tablebox").empty();
    var n = e.roadBeads.length - jsCode.count;
    $(e.roadBeads).each(function (t) {
        if (!(t < n && -1 != $.inArray(lotCode, jsCode.code))) {
            var a = "", i = s.find(".tablebox td:nth-child(1) p:last-child").text();
            s.find(".tablebox td:nth-child(1) p:last-child").css({"font-weight": "normal"});
            var c = e.state, o = "";
            if ("1" == c) 1 == (h = e.roadBeads[t]) ? o = "双" : 0 == h ? o = "和" : -1 == h && (o = "单"); else if ("2" == c) {
                var h = e.roadBeads[t];
                1 == h ? o = "大" : 0 == h ? o = "和" : -1 == h && (o = "小")
            } else "3" == c && (o = 1 == e.roadBeads[t] ? "龙" : "虎");
            if ("双" == o || "龙" == o || "大" == o ? a = "style='color:#f1020b'" : "和" == o && (a = "style='color:#0092dd'"), i == o) l = "<p  " + a + ">" + i + "</p>", s.find(".tablebox td:nth-child(1)").append(l); else {
                var d = "";
                s.find(".tablebox td:nth-child(1)").hasClass("bgcolor") || (d = "bgcolor"), l = "<td class='" + d + "'><p " + a + ">" + o + "</p></td>", "" == i ? s.find(".tablebox").append(l) : s.find(".tablebox td:nth-child(1)").before(l)
            }
        }
    }), bgPostionX(s);
    var i = 0, c = s.find(".tablebox td:nth-child(1) p:last-child");
    c.css({"font-weight": "bold"});
    var o = setTimeout(function () {
        c.fadeOut(100).fadeIn(100), 1 == ++i && (o = setInterval(arguments.callee, 600)), 30 == i && window.clearInterval(o)
    }, 1e3)
...
function boxList(t, e) {
    var s = "";
    return 1 == t && 1 == e.state ? s = "" + t + e.state : 1 == t && 2 == e.state ? s = "" + t + e.state : 1 == t && 3 == e.state ? s = "" + t + e.state : 1 == t && 4 == e.state ? s = "" + t + e.state : 1 == t && 5 == e.state ? s = "" + t + e.state : 1 == t && 6 == e.state ? s = "" + t + e.state : 1 == t && 7 == e.state ? s = "" + t + e.state : 2 == t && 1 == e.state ? s = "" + t + e.state : 2 == t && 2 == e.state ? s = "" + t + e.state : 2 == t && 3 == e.state ? s = "" + t + e.state : 2 == t && 4 == e.state ? s = "" + t + e.state : 2 == t && 5 == e.state ? s = "" + t + e.state : 2 == t && 6 == e.state ? s = "" + t + e.state : 2 == t && 7 == e.state ? s = "" + t + e.state : 3 == t && 1 == e.state ? s = "" + t + e.state : 3 == t && 2 == e.state ? s = "" + t + e.state : 3 == t && 3 == e.state ? s = "" + t + e.state : 3 == t && 4 == e.state ? s = "" + t + e.state : 3 == t && 5 == e.state ? s = "" + t + e.state : 3 == t && 6 == e.state ? s = "" + t + e.state : 3 == t && 7 == e.state ? s = "" + t + e.state : 4 == t && 1 == e.state ? s = "" + t + e.state : 4 == t && 2 == e.state ? s = "" + t + e.state : 4 == t && 3 == e.state ? s = "" + t + e.state : 4 == t && 4 == e.state ? s = "" + t + e.state : 4 == t && 5 == e.state ? s = "" + t + e.state : 4 == t && 6 == e.state ? s = "" + t + e.state : 4 == t && 7 == e.state ? s = "" + t + e.state : 5 == t && 1 == e.state ? s = "" + t + e.state : 5 == t && 2 == e.state ? s = "" + t + e.state : 5 == t && 4 == e.state ? s = "" + t + e.state : 5 == t && 5 == e.state ? s = "" + t + e.state : 5 == t && 6 == e.state ? s = "" + t + e.state : 5 == t && 7 == e.state ? s = "" + t + e.state : 6 == t && 1 == e.state ? s = "" + t + e.state : 6 == t && 2 == e.state ? s = "" + t + e.state : 6 == t && 4 == e.state ? s = "" + t + e.state : 6 == t && 5 == e.state ? s = "" + t + e.state : 6 == t && 6 == e.state ? s = "" + t + e.state : 6 == t && 7 == e.state ? s = "" + t + e.state : 7 == t && 1 == e.state ? s = "" + t + e.state : 7 == t && 2 == e.state ? s = "" + t + e.state : 7 == t && 4 == e.state ? s = "" + t + e.state : 7 == t && 5 == e.state ? s = "" + t + e.state : 7 == t && 6 == e.state ? s = "" + t + e.state : 7 == t && 7 == e.state ? s = "" + t + e.state : 8 == t && 1 == e.state ? s = "" + t + e.state : 8 == t && 2 == e.state ? s = "" + t + e.state : 8 == t && 4 == e.state ? s = "" + t + e.state : 8 == t && 5 == e.state ? s = "" + t + e.state : 8 == t && 6 == e.state ? s = "" + t + e.state : 8 == t && 7 == e.state ? s = "" + t + e.state : 9 == t && 1 == e.state ? s = "" + t + e.state : 9 == t && 2 == e.state ? s = "" + t + e.state : 9 == t && 4 == e.state && (s = "" + t + e.state), s
}

function forRankYibu(t, e) {
    var s = $("#box" + boxList(t, e)), a = "", l = "", n = s.find(".tablebox td:nth-child(1) p:last-child").text();
    s.find(".tablebox td:nth-child(1) p:last-child").css({"font-weight": "normal"});
    var i = e.state, c = "";
    "1" == i ? c = 1 == e.value ? "单" : "双" : "2" == i ? c = 1 == e.value ? "大" : "小" : "3" == i && (c = 1 == e.value ? "龙" : "虎"), "双" != c && "龙" != c && "大" != c || (l = "style='color:#f1020b'");
    var o = s.find(".left_count"), h = s.find(".right_count"), d = 1 * o.text() + 1, r = 1 * h.text() + 1;
    if ("单" == c ? o.text(d) : "双" == c ? h.text(r) : "大" == c ? o.text(d) : "小" == c ? h.text(r) : "龙" == c ? o.text(d) : "虎" == c && h.text(r), n == c) a = "<p  " + l + ">" + n + "</p>", s.find(".tablebox td:nth-child(1)").append(a); else {
        var m = "";
        s.find(".tablebox td:nth-child(1)").hasClass("bgcolor") || (m = "bgcolor"), a = "<td class='" + m + "'><p " + l + ">" + c + "</p></td>", "" == n ? s.find(".tablebox").append(a) : s.find(".tablebox td:nth-child(1)").before(a)
    }
    bgPostionX(s);
...
function loadotherData() {
    listData(getDateStr(0)), $(".listheadrl span").siblings().removeClass("checked"), $("#today").addClass("checked"), $(".jinri").text("今天")
}
...
$(function () {
    var t = config.formatDate();
    $("#date").val(t), $("#gotop").click(function () {
    ...
    $(".listheadl").find("span").live("click", function () {
        ...
        "1" == t ? (e = "1", $("#dxms,#lmms").hide(200), $("#zhms").show(200), excuteZhmsSelect(zhmssxmc, zhmssxlz)) : "2" == t ? (e = "1", $("#zhms,#lmms").hide(200), $("#dxms").show(200), excuteZhmsSelect(dxmssxmc, dxmssxlz)) : "3" == t && (e = "3", $("#dxms,#zhms").hide(200), $("#lmms").show(200), excuteZhmsSelect(lmmssxmc, lmmssxlz))
...
var zhmssxmc = [], zhmssxlz = [], dxmssxlz = [], dxmssxmc = [], lmmssxmc = [], lmmssxlz = [];