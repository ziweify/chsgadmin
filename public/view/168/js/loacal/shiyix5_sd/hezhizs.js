...
function doCheck(t, e) {
    ...
    var l = setTimeout(function () {
        r.fadeOut(100).fadeIn(100), 1 == ++c && (l = setInterval(arguments.callee, 600)), 30 == c && window.clearInterval(l)
    }, 1e3)
}
...
function listData(t, e) {
    t = void 0 == t ? "" : t, e = void 0 == e ? "" : e, $.ajax({
        url: urlbublic + "ElevenFive/queryElevnFiveSumTrend.do?issue=" + e + "&date=" + t,
        type: "GET",
...
function forRank(t) {
    $("#trend_table2 tbody").empty(), $(t[0].bodyList).each(function (t) {
        ...
        var a = "";
        $(s).each(function () {
            a += '<span class="kaijnum" style="margin-left:5px">' + this + "&nbsp;</span>"
        }), a = "<td>" + a + "</td>";
        var n = "", i = this.array;
        $(i).each(function () {
            n += "<td " + (1 * this >= 0 ? "title='0'" : "class='rank1 yilou'") + "><span>" + Math.abs(this) + "</td>"
        });
        var c = "<tr class='yiloutr' height='32'>" + e + a + n + "</tr>";
        $("#trend_table2 tbody").append(c)
...
function drawLine() {
    $("#chartLinediv canvas").remove(), tablename = "trend_table2", $("#" + tablename).find("tr").each(function () {
        $(this).find("td").each(function () {
            "0" == $(this).attr("title") && $(this).index() >= 2 && $(this).index() <= 31 && ($(this).attr("class", "hot " + $(this).removeClass("grey").attr("class")).find("span").attr("name", "hotSpan").text($(this).attr("name")).attr("class", "zoushiqiu bBK"), $(this).find("span").css("background", color[1]))
        })
    }), $("#" + tablename + " tr").eq($("#" + tablename + " tr").length - 8).find("td").removeClass("tdbb").addClass("tdbbs"), chartOfBaseTrend.shiyix5hez()
}
