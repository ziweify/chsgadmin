...
function doCheck(t, e) {
    ...
    var o = setTimeout(function () {
        c.fadeOut(100).fadeIn(100), 1 == ++r && (o = setInterval(arguments.callee, 600)), 30 == r && window.clearInterval(o)
    }, 1e3)
}
...
function listData(t, e) {
    t = void 0 == t ? "" : t, e = void 0 == e ? "" : e, $.ajax({
        url: urlbublic + "ElevenFive/queryElevnFiveNumberTrend.do?issue=" + e + "&date=" + t,
        type: "GET",
...
function forRank(t) {
    ...
    $("#trend_table2 tbody").empty(), $(t[0].bodyList).each(function (t) {
        ...
        var e = '<td class="leftth">' + this.issue + "</td>", s = "";
        $(this.code.split(",")).each(function () {
            s += '<span class="kaijnum" style="margin-right:8px">' + this + "</span>"
        }), s = "<td>" + s + "</td>";
        var a = "", n = $(this.code.split(",")), i = "";
        $(this.array).each(function (t) {
            var e = !1;
            if (t <= 10) {
                var s = t + 1;
                $(n).each(function (t) {
                    (i = 0 == n[t].substr(0, 1) ? n[t].substr(1, 2) : n[t]) == s && (e = !0)
                }), a += e ? "<td " + "title='0'" + "><span>" + (1 * t + 1) + "</span></td>" : "<td " + "class='rank1 yilou'" + "><span>" + Math.abs(this) + "</span></td>"
            } else a += "<td " + (1 * this > 0 ? "title='0'" : "class='rank1 yilou'") + "><span>" + Math.abs(this) + "</span></td>"
        });
        var r = "<tr class='yiloutr' height='32'>" + e + s + a + "</tr>";
        $("#trend_table2 tbody").append(r)
    ...
    var e = "<td class='font14' colspan='2'>出现次数</td>", s = "<td class='font14' colspan='2'>平均遗漏</td>",
        a = "<td class='font14' colspan='2'>最大遗漏</td>", n = "<td class='font14' colspan='2'>最大连出</td>",
        i = "<td class='font14' colspan='2'>当前遗漏</td>";
    $(t[0].missList).each(function (t) {
        0 == t ? $(this.array).each(function () {
            ...
            i += this >= 0 ? "<td class='font14'>0</td>" : "<td class='font14'>" + Math.abs(this) + "</td>"
        })
    }), $("#trend_table2 tbody").append("<tr>" + e + "</tr><tr>" + s + "</tr><tr>" + a + "</tr><tr>" + n + "</tr><tr style='display:none'>" + i + "</tr>")
}

function drawLine() {
    $("#chartLinediv canvas").remove(), tablename = "trend_table2", $("#" + tablename).find("tr").each(function () {
        $(this).find("td").each(function (t) {
            0 == $(this).attr("title") && $(this).css({background: "#fcf8f3"}), "0" == $(this).attr("title") && ($(this).index() >= 2 && $(this).index() <= 12 ? ($(this).attr("class", "hot " + $(this).removeClass("grey").attr("class")).find("span").attr("name", "hotSpan").text($(this).attr("name")).attr("class", "zoushiqiu gB"), $(this).find("span").css("background", color[1])) : $(this).index() >= 14 && $(this).index() <= 25 && ($(this).attr("class", "hot " + $(this).removeClass("grey").attr("class")).find("span").attr("name", "hotSpan").text($(this).attr("name")).attr("class", "zoushiqiuf jitdbg"), 14 == $(this).index() ? ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("大"), $(this).find("span").css("background", color[4])) : 15 == $(this).index() ? ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("小"), $(this).find("span").css("background", color[4])) : 16 == $(this).index() ? ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("和"), $(this).find("span").css("background", color[4])) : 17 == $(this).index() ? ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("单"), $(this).find("span").css("background", color[7])) : 18 == $(this).index() ? ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("双"), $(this).find("span").css("background", color[7])) : 19 == $(this).index() ? ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("和"), $(this).find("span").css("background", color[7])) : 20 == $(this).index() ? ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("尾大"), $(this).find("span").css("background", color[10])) : 21 == $(this).index() && ($(this).find("span").attr("title", $(this).find("span").text()), $(this).find("span").text("尾小"), $(this).find("span").css("background", color[10]))))
        })
