function ajaxRequst(e, t) {
    ...
    // } else "#pk10" == t || "#pk10_hot" == t ? indexObj.ajaxpk10(e, lotCode.pk10, t) : 
    ...
    //  "#tjklsf" == t ? indexObj.ajaxKlsf(e, lotCode.tjklsf, t) : 
    //  "#aozxy8" == t ? indexObj.ajaxKlsf(e, lotCode.aozxy8, t) : 
    //  "#kuai3" == t ? indexObj.ajaxKuai3(e, lotCode.jsksan, t) : 
    //  "#gxk3" == t ? indexObj.ajaxKuai3(e, lotCode.gxft, t) : 
    //  "#bjk3" == t ? indexObj.ajaxKuai3(e, lotCode.bjft, t) : 
    //  "#shiyix5_sd" == t || "#shiyix5_sd_hot" == t ? indexObj.shiyix5(e, lotCode.sdsyydj, t) : 
    //  "#shiyix5_gd" == t ? indexObj.shiyix5(e, lotCode.gdsyxw, t) : 
    //  "#sg11x5" == t ? indexObj.shiyix5(e, lotCode.sg11x5, t) : 
    ...
    //   "#smallSixInfo_hot" == t || "#smallSixInfo" == t ? indexObj.ajaxSmallSixInfo(e, lotCode.xglhc, t) : 
    //   "#speedSix" == t ? indexObj.speedSixInfo(e, lotCode.jslhc, t) : 
    //   "#taiwanBigLottery" == t && indexObj.ajaxSsc(e, lotCode.tw_dlt, t)
    if(void 0 !== n && n.category == "ssc"){
        indexObj.ajaxSsc(e, lotCode[a], t);
    }else if(void 0 !== n && n.category == "pk10"){
        indexObj.ajaxpk10(e, lotCode[a], t)
    }else{
        if("#pk10" == t || "#pk10_hot" == t){
            indexObj.ajaxpk10(e, lotCode.pk10, t)
        }else if("#jisusc" == t || "#jisuscHot" == t){
            indexObj.ajaxpk10(e, lotCode.jisusc, t)
        }else if("#jisuft" == t || "#jisuftHot" == t){
            indexObj.ajaxpk10(e, lotCode.jisuft, t)
        }else if("#xingyft" == t || "#xingyft_hot" == t){
            indexObj.ajaxpk10(e, lotCode.xingyft, t)
        }else if("#sgAirship_hot" == t || "#sgAirship" == t){
            indexObj.ajaxpk10(e, lotCode.sgAirship, t)
        }else if("#aozxy10" == t){
            indexObj.ajaxpk10(e, lotCode.aozxy10, t)
        }else if("#cqSsc" == t || "#cqSsc_hot" == t){
            indexObj.ajaxSsc(e, lotCode.cqssc, t)
        }else if( "#xySsc" == t || "#xySsc_hot" == t){
            indexObj.ajaxSsc(e, lotCode.xyssc, t)
        }else if("#jisussc" == t || "#jisusscHot" == t){
            indexObj.ajaxSsc(e, lotCode.jisussc, t)
        }else if("#happyCZ" == t || "#happyCZ_hot" == t){
            indexObj.ajaxSsc(e, lotCode.happyCZ, t)
        }else if("#tjSsc" == t){
            indexObj.ajaxSsc(e, lotCode.tjssc, t)
        }else if("#tw_5fencai" == t || "#tw_5fencaiHot" == t){
            indexObj.ajaxSsc(e, lotCode.tw_5fencai, t)
        }else if("#xjSsc" == t){
            indexObj.ajaxSsc(e, lotCode.xjssc, t)
        }else if("#gdklsf" == t){ 
            indexObj.ajaxKlsf(e, lotCode.gdklsf, t)
        }else if("#tjklsf" == t){
            indexObj.ajaxKlsf(e, lotCode.tjklsf, t)
        }else if("#jisuklsf" == t){
            indexObj.ajaxKlsf(e, lotCode.jisuklsf, t)
        }else if("#bgklsf" == t){
            indexObj.ajaxKlsf(e, lotCode.bgklsf, t)
        }else if("#aozxy8" == t){
            indexObj.ajaxKlsf(e, lotCode.aozxy8, t)
        }else if("#kuai3" == t){
            indexObj.ajaxKuai3(e, lotCode.jsksan, t)
        }else if("#jisuksan" == t){
            indexObj.ajaxKuai3(e, lotCode.jisuksan, t)
        }else if("#bgk3" == t){
            indexObj.ajaxKuai3(e, lotCode.bgk3, t)
        }else if("#gxk3" == t){
            indexObj.ajaxKuai3(e, lotCode.gxft, t)
        }else if("#bjk3" == t){
            indexObj.ajaxKuai3(e, lotCode.bjft, t)
        }else if("#shiyix5_sd" == t || "#shiyix5_sd_hot" == t){
            indexObj.shiyix5(e, lotCode.sdsyydj, t)
        }else if("#shiyix5_gd" == t){
            indexObj.shiyix5(e, lotCode.gdsyxw, t)
        }else if("#sg11x5" == t){
            indexObj.shiyix5(e, lotCode.sg11x5, t)
        }else if("#jisuef" == t){
            indexObj.shiyix5(e, lotCode.jisuef, t)
        }else if("#bg11x5" == t){
            indexObj.shiyix5(e, lotCode.bg11x5, t)
        }else if("#11ckeck5_zjef" == t){
            indexObj.shiyix5(e, lotCode.zjef, t)
        }else if("#cqnc" == t){ 
            indexObj.ajaxCqnc(e, lotCode.cqxync, t)
        }else if("#egxy28" == t){
            indexObj.ajaxPCdd(e, lotCode.egxy28, t)
        }else if("#tcpl3" == t){
            indexObj.ajaxTcpl3(e, lotCode.pailie3, t)
        }else if("#fc3d" == t){
            indexObj.ajaxTcpl3(e, lotCode.fcsd, t)
        }else if("#gxklsf" == t){
            indexObj.ajaGxklsf(e, lotCode.gxklsf, t)
        }else if("#sgSsc" == t || "#sgSsc_hot" == t){
            indexObj.ajaxSsc(e, lotCode.sgssc, t)
        }else if("#kuai3_sg" == t || "#kuai3_sg_hot" == t){
            indexObj.ajaxKuai3(e, lotCode.sgk3, t)
        }else if("#smallSixInfo_hot" == t || "#smallSixInfo" == t){
            indexObj.ajaxSmallSixInfo(e, lotCode.xglhc, t)
        }else if("#speedSix" == t){
            indexObj.speedSixInfo(e, lotCode.jslhc, t)
        }else if("#taiwanBigLottery" == t && indexObj.ajaxSsc(e, lotCode.tw_dlt, t)){
            indexObj.ajaxSsc(e, lotCode.tw_dlt, t)
        }else if("#aomenSix" == t){
            indexObj.aomenSixInfo(e, lotCode.amlhc, t)
        }
    }
}

function nextopenTime(e, t, a) {
    ...
    clearInterval(nexttimeinter[a]), nexttimeinter[a] = setInterval(function () {
        ...
        if (l = new Date, (e = e.toString().split("."))[0] > 1 && (u -= e[0]), !(u > 1)) return clearInterval(nexttimeinter[a]), void ajaxRequst($(a).find(".nextId").text(), a);
        u -= 1;
...
function iframe(e) {
    var t = "", a = "", n = {
        ...
        sg11x5: "11x5_video/index.html?10084",
    ...
    $("#videobox").find("#vtitle").text(a), $("#videoIframe").find("iframe").attr("src", config.videourl+"view/video/"+t)
}
...
var publicUrl = config.publicUrl,imgUrl = config.imgUrl,
...
indexObj.ajaGxklsf = function (e, t, a) {
    ...
    n.totalCount;
    var i = n.totalCount;
    if ($(a).find(".preDrawIssue").text(n.preDrawIssue), $(a).find(".nextId").text(n.drawIssue), $(a).find(".drawCount").text(n.drawCount), $(a).find(".sdrawCountnext").text(1 * i - 1 * n.drawCount), $(a).find(".sumNum").text(n.sumNum), "#egxy28" == a) {
...
indexObj.ajaxSmallSixInfo = function (e, t, a) {
    e = void 0 == e ? "" : e, $.ajax({
        url: config.publicUrl + "smallSix/findSmallSixInfo.do?issue="+e,
        type: "GET",
        timeout: 6e4,
        data: {lotCode: t},
        dataType: "json",
        ...
        success: function (t) {
            try {
                if ("100002" == t.result.businessCode) throw new Error("error");
                clearInterval(nexttimeinter[a]), nextopenTime(t.result.data.drawTime, t.result.data.serverTime, a), indexObj.renderSmallSixLottery(t, a)
            } catch (t) {
                indextools.repeatAjax(e, a)
            }
        },
    ...
    e = void 0 == e ? "" : e;
    $.ajax({
        url: config.publicUrl + "speedSix/findSpeedSixInfo.do?issue="+e,
        type: "GET",
        timeout: 6e4,
        data: {lotCode: t},
        dataType: "json",
...
}, indexObj.aomenSixInfo = function (e, t, a) {
    e = void 0 == e ? "" : e;
    $.ajax({
        url: config.publicUrl + "smallSix/findSmallSixInfo.do?issue="+e,
        type: "GET",
    ...
    var n = $(a);
    n.find(".nextIssue").text(e.result.data.drawIssue), n.find(".nextId").text(e.result.data.drawIssue), n.find(".preDrawIssue").text(e.result.data.preDrawIssue), n.find(".opentyle").hide();
    ...
    if (1 !== (n = n.result.data).lotteryStatus) {
        ...
        $(a).find(".nextIssue").text(n.drawIssue), $(a).find(".nextId").text(n.drawIssue), $(a).find(".preDrawIssue").text(n.preDrawIssue), $("#drawCount1").text(n.drawCount), $("#sdrawCount1").text(i - 1 * n.drawCount);
    ...
    if (1 !== (n = n.result.data).lotteryStatus) {
        if (tools.operatorTime("" == n.drawTime ? "0" : n.drawTime, n.serverTime) <= 0) throw new Error("error");
        var i = n.totalCount;
        $(a).find(".preDrawIssue").text(n.preDrawIssue), $(a).find(".nextId").text(n.drawIssue), $(a).find(".nextIssue").text(n.drawIssue), $(a).find(".drawCount").text(n.drawCount), $(a).find(".sdrawCountnext").text(1 * i - 1 * n.drawCount), $(a).find(".sumNum").text(n.sumNum), $(a).find(".sumSingleDouble").text(0 == n.sumSingleDouble ? "单" : "双"), $(a).find(".sumBigSmall").text(0 == n.sumBigSmall ? "大" : "小");
        var o = "";
    ...
    if (1 !== (n = n.result.data).lotteryStatus) {
        if (tools.operatorTime("" == n.drawTime ? "0" : n.drawTime, n.serverTime) <= 0) throw new Error("error");
        var i = n.totalCount;
        $(a).find(".preDrawIssue").text(n.preDrawIssue), $(a).find(".nextIssue").text(n.drawIssue), $(a).find(".nextId").text(n.drawIssue), $(a).find(".drawCount").text(n.drawCount), $(a).find(".sdrawCountnext").text(1 * i - 1 * n.drawCount), $(a).find(".sumNum").text(n.sumNum), $(a).find(".sumSingleDouble").text(0 == n.sumSingleDouble ? "单" : "双"), $(a).find(".sumBigSmall").text(typeOf("Indxh", n.sumBigSmall));
    ...
    if (1 !== (a = a.result.data).lotteryStatus) {
        ...
        $(t).find(".preDrawIssue").text(a.preDrawIssue), $(t).find(".nextId").text(a.drawIssue), $(t).find(".nextIssue").text(a.drawIssue), $(t).find(".drawCount").text(a.drawCount), $(t).find(".sdrawCountnext").text(84 - 1 * a.drawCount), $(t).find(".sumNum").text(a.sumNum), $(t).find(".sumSingleDouble").text(0 == a.sumSingleDouble ? "单" : "双"), $(t).find(".sumBigSmall").text(0 == a.sumBigSmall ? "大" : "小"), $(t).find(".lastBigSmall").text(0 == a.lastBigSmall ? "尾大" : "尾小");
    ...
    a.totalCount;
    $(t).find(".preDrawIssue").text(a.preDrawIssue), $(t).find(".nextId").text(a.drawIssue), $(t).find(".nextIssue").text(a.drawIssue), tools.countDown(a.drawTime, a.serverTime, t, a.lotteryStatus), animateMethod.sscAnimateEnd(a.preDrawCode, t), toolBoxs.resetRed(t), $("#waringbox").hide(300);
...
var smallSixInfoCountDownTimer, MyFavObj = {
    ...
    renderData: function (e) {
        ...
        if (1 !== t.lotteryStatus) {
            ...
            if (l.find(".lotName").text(t.lotName), "pk10" === i ? u = u.split(",") : "egxy" === i && (u = t.preDrawCode + "," + t.sumNum), "10060" == a ? animateMethod.happyCZAnimateEnd(u, o) : animateMethod[r](u, o), "qgc1" === i && (d = this.setKajianhaoColor.qgc), d && d(o), l.find(".nextId").text(t.drawIssue), l.find(".nextIssue").text(t.drawIssue), l.find(".preDrawIssue").text(t.preDrawIssue), l.find(".opentyle").hide(), "sixLotterySpeed" === i || "sixLotteryInfo" === i) {
    ...
    smallSixInfoCountDown: function (e, t, a, n) {
        ...
        clearInterval(smallSixInfoCountDownTimer), smallSixInfoCountDownTimer = setInterval(function () {
            ...
            if (p = new Date, (e = e.toString().split("."))[0] > 1 && (m -= e[0]), m > 1) {
                ...
                var y = o.find(".nextId").text(), j = s.isLotterySeries(a),
