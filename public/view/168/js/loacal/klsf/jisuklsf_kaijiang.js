...
function typeOf(e, t) {
    if ("rank" == e) switch (1 * t) {
        ...
        case 11:
            return "总和为和"
    } else if ("dxhList" == e) return 1 * t == 0 ? "小" : 1 * t == 1 ? "大" : "和"
}
...
function creatDataHead(e, t) {
    publicmethod.insertHeadKlsf(e, t), tools.setTimefun_gdklsf()
}
function initMenu(){
...
$(function () {
    ...
    initMenu();
    $("#headdivbox").load("../public/head.html?v=1", function () {
        pupajax(), config.ifdebug
    }), $("#fooderbox").load("../public/fooder.html", function () {
        config.ifdebug
    }), tools.showExplain(), tools.playVideo_klsf(), $(".listheadrl span").live("click", function () {
...
indexObj.ajaxSsc = function (e, t) {
    ...
    var r = !1;
    $.ajax({
        url: urlbublic + "klsf/getLotteryInfo.do?issue=" + e,
        type: "GET",
