...
$(function () {
    ...
    $.ajax({
        type: "get",
        url: config.publicUrl + "findPreDrawYearAll.do?",
        dataType: "json",
        async: !1,
        success: function (a) {
    ...
    smSixTools.yearsFun(0 != $(".xzsx>li .checked").length ? $(".xzsx>li>.checked").parent().attr("lang") : 1, a)
}), $(".xzsx>li:not(title)").click(function () {
    var s = $(this).attr("lang"), e = $(".years_list>li>.active").text();
    ...
    1 == s ? attrArr = proto.Zoo : 2 == s ? attrArr = proto.fiveLineArr : 3 == s ? attrArr = proto.jiaqzs : 4 == s ? attrArr = proto.boy_girl : 5 == s ? attrArr = proto.top_bottom : 6 == s ? attrArr = proto.four_season : 7 == s ? attrArr = proto.cqsh : 8 == s && (attrArr = proto.colorCh), $.ajax({
        type: "post",
        url: config.publicUrl + "smallSix/findSmallSixHistory.do?",
        data: {year: e, type: s},
        dataType: "json",
        beforeSend: function () {
    ...
    smSixTools.yearsFun(1, "")
}), $(".checksapn").on("click", function () {
    //$(".listhead").find(".checksapn").removeClass("active");
    var s = $(this).attr("class").split(" ")[1];
    return "wanfaxume" == s ? ($(this).addClass("active").siblings(".checksapn").removeClass("active"), $(".listbox_2").show().siblings(".listbox").hide(), $(".ch-right").hide(), !1) : ($(".listbox").show(), "haomafenbu" == s ? ($(this).hasClass("active"),$("#wanfaxume").hide(350) ? $(".hmfb").show(350) : $(".hmfb").show(350), $(this).toggleClass("active").siblings(".checksapn").removeClass("active"), $("#" + s).show().siblings(".hmfbTable").hide(), !1) : ($(".hmfb").hide(350), (!$(this).hasClass("active") || "haomafenbu" == s) && ($(this).addClass("active").siblings(".checksapn").removeClass("active"), $("#" + s).show().siblings(".hmfbTable").hide(), checkPpage($(".date").val(), $(".xzsx li>a.checked").parents().attr("lang")), $(".listbox_2").hide(), void $(".ch-right").show())))
