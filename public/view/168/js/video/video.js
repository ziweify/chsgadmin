...
$(function () {
    ...
    type: function (e) {
        for (var t = [["cqnc", "10009"], ["xgc", "10048", "10051"], ["egxy", "10046", "10074", "10081"], ["gxklsf", "10038"], ["jisuft", "10035", "10057", "10058"], ["twbg", "10047"], ["fcsd", "10041", "10043"], ["bjkl8", "10013", "10014", "10054", "10073", "10080", "10082","20036"], ["klsf","20034", "10005", "10011", "10034", "10053", "10078", "10083"], ["pk10", "20031", "10001", "10012", "10037", "10079", "30002", "30004", "30008", "30009", "30010"], ["qgc", "10039", "10040", "10042", "10044", "10045"], ["ssc","20032", "10002", "10003", "10004", "10010", "10036", "10050", "10059", "10060", "10064", "10065", "10066", "10070", "10071", "10072", "10075", "10077", "30001", "30003", "30005", "30006", "30007"], ["kuai3", "10007", "20035", "10026", "10027", "10028", "10029", "10030", "10031", "10032", "10033", "10052", "10061", "10062", "10063", "10076"], ["shiyi5","20033", "10006","2003310051", "10008", "10015", "10016", "10017", "10018", "10019", "10020", "10021", "10022", "10023", "10024", "10025", "10055", "10084"]], o = 0, r = t.length; o < r; o++) for (var s = 0, i = t[o].length; s < i; s++) if (e == t[o][s]) return t[o][0]
    },
    action: {
    ...
    console.log('eeee',e)
    var s = {
        url: pubmethod.tools.action[o], issue: e, lotCode: t, flag: r, type: o, succM: function (e, t) {
    ...
    pk10: function (e, t) {
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            if (r = r < 0 ? 1 : r, showcurrentresult(i), $("#currentdrawid").text(o.drawCount), $("#drawIssue").val(o.drawIssue), $("#nextdrawid").text(o.preDrawIssue), $("#stat1_1").text(o.sumFS), $("#stat1_2").text("0" == o.sumBigSamll ? "大" : "小"), $("#stat1_3").text("0" == o.sumSingleDouble ? "单" : "双"), $("#stat2_1").text("0" == o.firstDT ? "龙" : "虎"), $("#stat2_2").text("0" == o.secondDT ? "龙" : "虎"), $("#stat2_3").text("0" == o.thirdDT ? "龙" : "虎"), $("#stat2_4").text("0" == o.fourthDT ? "龙" : "虎"), $("#stat2_5").text("0" == o.fifthDT ? "龙" : "虎"), t.flag) $("#hlogo").find("img").attr("src", "images/logo/logo-" + t.lotCode + ".png"), $(".statuslogo").css({background: "url(images/logo/logo-" + t.lotCode + ".png)no-repeat"}), startcountdown(r, t); else {
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            if (t.flag) pcEgg.startVid(l, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
                    pcEgg.stopVid(l, t)
                }, "1000")
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            o = o.result.data;
            for (var r = pubmethod.tools.cutTime(o.drawTime, o.serverTime), s = o.preDrawCode.split(","), i = [], u = 0, n = s.length; u < n; u++) "0" == s[u].substr(0, 1) ? i.push(s[u].substr(1, 1)) : i.push(s[u]);
            if (r = r < 0 ? 1 : r, t.flag) cqncVideo.statusFun(o.preDrawIssue, i, r, !0, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
                    stopanimate(i, r, t)
                }, "1000")
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            if (r = r < 0 ? 1 : r, console.log(i), t.flag) $(".nameLogo").find("img").attr("src", "img/logo/11x5_" + t.lotCode + ".png"), k3v.startVideo(o, t), console.log($(".nameLogo"), t); else {
                if (!t.flag && r <= 1) throw new Error("error");
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            for (var r = pubmethod.tools.cutTime(o.drawTime, o.serverTime), s = o.preDrawCode.split(","), i = [], u = 0, n = s.length; u < n; u++) "0" == s[u].substr(0, 1) ? i.push(1 * s[u].substr(1, 1)) : i.push(1 * s[u]);
            r = r < 0 ? 1 : r;
            var l = o.preDrawIssue, a = o.drawIssue, d = o.drawTime.split(" ")[1].slice(0, 5);
            if (t.flag) $(".video_box").css("background", "url(img/logo/" + t.lotCode + ".jpg) 0 0 no-repeat"), fun.fillHtml(l, a, d, r, i, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            if (t.flag) $(".nameLogo").find("img").attr("src", "img/logo/" + t.lotCode + ".png"), k3v.stopVideo(l, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
                    k3v.stopVideo(l, t)
                }, "1000")
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            o.drawTime.split(" ")[1];
            if (console.log(o), o.preDrawCode = i, t.flag) $(".logo").css("background", "url(img/logo/" + t.lotCode + ".png) center center no-repeat"), fcsdv.startVid(o, t); else {
                if (t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
                    fcsdv.stopVid(o, t)
                }, "1000")
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            o = o.result.data;
            var r = pubmethod.tools.cutTime(o.drawTime, o.serverTime), s = o.preDrawCode.split(","), i = [];
            "10073" == o.lotCode ? s.push("101") : "10054" != o.lotCode && "10082" != o.lotCode || (s[s.length - 1] = "101");
            for (var u = 0, n = s.length; u < n; u++) "0" == s[u].substr(0, 1) ? i.push(1 * s[u].substr(1, 1)) : i.push(1 * s[u]);
            if (r = r < 0 ? 1 : r, o.cutime = r, console.log(o), o.preDrawCode = i, t.flag) $(".logo").css("background", "url(img/logo/" + t.lotCode + ".png) center center no-repeat"), syxwV.startVid(o, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
                    syxwV.stopVid(o, t)
                }, "1000")
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            o = o.result.data;
            for (var r = pubmethod.tools.cutTime(o.drawTime, o.serverTime), s = o.preDrawCode.split(","), i = [], u = 0, n = s.length; u < n; u++) "0" == s[u].substr(0, 1) ? i.push(1 * s[u].substr(1, 1)) : i.push(1 * s[u]);
            if (r = r < 0 ? 1 : r, o.cutime = r, console.log(o), o.preDrawCode = i, t.flag) syxwV.startVid(o, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
                    syxwV.stopVid(o, t)
                }, "1000")
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            o = o.result.data;
            for (var r = pubmethod.tools.cutTime(o.drawTime, o.serverTime), s = o.preDrawCode.split(","), i = [], u = 0, n = s.length; u < n; u++) "0" == s[u].substr(0, 1) ? i.push(1 * s[u].substr(1, 1)) : i.push(1 * s[u]);
            if (r = r < 0 ? 1 : r, o.cutime = r, console.log(o), o.numArr = i, t.flag) gxklsf.startVid(o, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
                    gxklsf.stopVid(o, t)
                }, "1000")
        ...
        if ("100002" == o.result.businessCode) throw new Error("error");
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            $("#drawIssue").text(o.result.data.drawIssue);
            o = o.result.data, $("#status").css("background-image", "../images/logo_" + o.lotCode + ".png"), $(".logo").find("img").attr("src", "images/logo_" + o.lotCode + ".png");
            for (var r = pubmethod.tools.cutTime(o.drawTime, o.serverTime), s = o.preDrawCode.split(","), i = [], u = 0, n = s.length; u < n; u++) "0" == s[u].substr(0, 1) ? i.push(1 * s[u].substr(1, 1)) : i.push(1 * s[u]);
            if (r = r < 0 ? 1 : r, o.cutime = r, console.log(o), showcurrentresult(o.preDrawCode), $("#currentdrawid").text(o.drawCount), $("#nextdrawid").text(o.preDrawIssue), $("#stat1_1").text(o.sumFS), $("#stat1_2").text("0" == o.sumBigSamll ? "大" : "小"), $("#stat1_3").text("0" == o.sumSingleDouble ? "单" : "双"), $("#stat2_1").text("0" == o.firstDT ? "龙" : "虎"), $("#stat2_2").text("0" == o.secondDT ? "龙" : "虎"), $("#stat2_3").text("0" == o.thirdDT ? "龙" : "虎"), $("#stat2_4").text("0" == o.fourthDT ? "龙" : "虎"), $("#stat2_5").text("0" == o.fifthDT ? "龙" : "虎"), t.flag) startcountdown(r, t); else {
                if (!t.flag && r <= 1) throw new Error("error");
                setTimeout(function () {
