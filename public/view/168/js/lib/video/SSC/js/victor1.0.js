...
function sscAnimateEnd(o, e) {
    ifopen && (lotCodestr = e, animate.sscAnimateEnd(o.preDrawCode, o.id, o.counttime, !1), videoTools.inseartData(o), datestr = o.counttime, preDrawCode = o.preDrawCode)
}
...
null != query_code && (img_src = "img/" + query_code + "_logo.png", $("#video-logo").attr("src", img_src));
var lotCodestr = "", animate = {}, datestr = "", timerInterval = "", ifopen = !1, preDrawCode = "", animateID = [],
    videoTools = {};
animate.sscAnimate = function (o) {
    ...
    if (ifopen) {
        ...
        var i = [];
        $(t).each(function (e) {
            $(this).find("span").text(""), "10060" == lotCodestr ? $(this).find("span").removeClass().addClass("cznum" + o[e]) : $(this).find("span").removeClass().addClass("num" + o[e]), i.push($(this).find("span"))
        }), videoTools.showNUM(i, o), s || videoTools.cutTime(n)
    }
    ...
    clearInterval(animateID.timer), timerInterval = setInterval(function () {
        if (e >= 1) {
            e -= 1;
            var o = Math.floor(e / 3600), n = Math.floor(e / 60 % 60), s = Math.floor(e % 60), t = "";
            t = (t = o <= 0 ? "" : (o < 10 ? "0" + o : o) + ":") + "" + (n < 10 ? "0" + n : n) + ":" + (s < 10 ? "0" + s : s), $(".bluefont").text(t)
