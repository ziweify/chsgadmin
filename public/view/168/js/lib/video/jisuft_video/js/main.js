...
function animate() {
    ...
    var _ = Math.floor(1100 * Math.random() + 200);
    activateflame(_, "10"), _ += "px";
    var A = document.getElementById("car1"), L = document.getElementById("car2"), H = document.getElementById("car3"),
        N = document.getElementById("car4"), D = document.getElementById("car5"), S = document.getElementById("car6"),
        C = document.getElementById("car7"), q = document.getElementById("car8"), F = document.getElementById("car9"),
        G = document.getElementById("car10");
    TweenMax.to(A, a, {left: $, delay: d}), TweenMax.to(L, t, {left: M, delay: m}), TweenMax.to(H, e, {
        left: x,
        delay: f
    }), TweenMax.to(N, n, {left: I, delay: u}), TweenMax.to(D, o, {left: T, delay: p}), TweenMax.to(S, r, {
        left: B,
        delay: h
    }), TweenMax.to(C, l, {left: k, delay: y}), TweenMax.to(q, i, {left: E, delay: v}), TweenMax.to(F, s, {
        left: b,
        delay: g
    }), TweenMax.to(G, c, {left: _, delay: w})
}
...
function startcountdown(a) {
    ...
    stopanimation(), $("#car1").css("left", "1206px"), $("#car2").css("left", "1197px"), $("#car3").css("left", "1181px"), $("#car4").css("left", "1166px"), $("#car5").css("left", "1153px"), $("#car6").css("left", "1139px"), $("#car7").css("left", "1128px"), $("#car8").css("left", "1105px"), $("#car9").css("left", "1084px"), $("#car10").css("left", "1067px"), $(".roadstart").css("left", "960px"), $(".trafficlight").css("display", "block"), $(".redlight").css("display", "none"), $(".yellowlight").css("display", "none"), $(".greenlight").css("display", "none"), $(".countdownnum").html(""), $(".countdownnum2").html(""), $(".countdownnum").css("display", "block"), $(".countdownnum2").css("display", "block"), countdowninv = setInterval(function () {
        countdowntimer(a -= 1), countdown(a), 0 == a && (clearInterval(countdowninv), clearInterval(countdowninv2))
    }, 1e3);
    var t = 99;
...
function countdowntimer(a) {
    a >= 0 ? $(".trafficlight").css("display", "block") : $(".trafficlight").css("display", "none"), a <= 2 && a > 0 && ($(".redlight").css("display", "block"), playing.pause(), playing = document.getElementById("cuttime"), ifopen && isplay && playing.play()), a <= 1 && $(".yellowlight").css("display", "block"), 0 == a && (startanimation(), $(".countdownnum").html("00:00"), $(".countdownnum2").html("00"), $(".greenlight").css("display", "block"), $(".trafficlight").delay(500).fadeOut(300))
}

function startanimation() {
    $(".wheel10a img").css("animation", "twinkling 0.01s  ease-in-out  infinite"), playing.pause(), playing = document.getElementById("running"), ifopen && isplay && playing.play(), addint = setInterval(function () {
        ShipUndulation()
    }, 200), wheelon();
...
function finishgame(a, t, e) {
    if (TweenLite.killDelayedCallsTo(winnerpage), $(".page1").css("display", "block"), $(".page2").css("display", "none"), playing.pause(), playing = document.getElementById("running"), ifopen && isplay && playing.play(), 1 == waitfinish) return !1;
    waitfinish = !0, TweenMax.killAll(), wheelon(), $("#roaditm").css("left", "-1300px");
    var n = document.getElementById("roaditm");
    TweenMax.to(n, .4, {left: "-120px", repeat: -1, ease: Linear.easeNone});
    var o = document.getElementById("scenaryitm");
    TweenMax.to(o, 20, {left: "0", repeat: -1, ease: Linear.easeNone});
    var r = document.getElementById("roadstart");
    TweenMax.to(r, 1, {left: "1334px", ease: Linear.easeNone, delay: 3});
    ...
    for (var i = a.split(","), s = 0; s < 10; s++) {
        var c = Math.floor(10 * Math.random() + 1);
        c /= 10;
        var d = parseInt(i[s]) - 1, m = 100 * s - carpositionoffset[d] + 350, f = m + "px", u = "car" + i[s],
            p = document.getElementById(u);
        activateflame(m, i[s]), TweenMax.to(p, 3, {left: f, delay: c})
    }
    $(".flashlight").delay(3200).fadeIn(100, function () {
        $(".flashlight").fadeOut(500), clearInterval(l), waitfinish = !1, resultpage(a)
    }), void 0 != t && setTimeout(function () {
        startcountdown(t)
    }, 1e4), $("#stat1_1").text(e.sumFS), $("#stat1_2").text("0" == e.sumBigSamll ? "大" : "小"), $("#stat1_3").text("0" == e.sumSingleDouble ? "单" : "双"), $("#stat2_1").text("0" == e.firstDT ? "龙" : "虎"), $("#stat2_2").text("0" == e.secondDT ? "龙" : "虎"), $("#stat2_3").text("0" == e.thirdDT ? "龙" : "虎"), $("#stat2_4").text("0" == e.fourthDT ? "龙" : "虎"), $("#stat2_5").text("0" == e.fifthDT ? "龙" : "虎")
}

function resultpage(a) {
    if ($(".page1").css("display", "block"), $(".page2").css("display", "none"), playing.pause(), playing = document.getElementById("kaisound"), ifopen && isplay && playing.play(), 1 == waitfinish) return !1;
...
$(function () {
    ...
    null != query_code && (img_src = "images/" + query_code + ".png", $("#video-logo").attr("src", img_src));
