function sscAnimateEnd(o, e) {
    lotCodestr = lotCode, animate.sscAnimateEnd(o.preDrawCode, o.id, o.counttime, !1, e), videoTools.inseartData(o), datestr = o.counttime, preDrawCode = o.preDrawCode
}
...
var lotCodestr = "", animate = {}, datestr = "", timerInterval = "", preDrawCode = "", animateID = [], videoTools = {};
animate.sscAnimate = function (o) {
    clearInterval(animateID[o]), videoTools.ifsund() && ($("#bgsound").attr("src", "sound/opening.mp3"), videoTools.sounds.soundsT.play("bgsound"));
    var e = setInterval(function () {
        for (var e = $(o).find(".box"), n = $(e).find("span").length, s = 0; s < n; s++) {
            "10060" == lotCodestr ? ($(e).find("span").css("color", "transparent"), $(e).find("span").eq(s).removeClass().addClass("cznum" + $(e).find("span").eq(s).text())) : $(e).find("span").eq(s).removeClass().addClass("num" + $(e).find("span").eq(s).text()), $(e).find("span").eq(s).css({
            ...
            $(e).find("span").eq(s).stop().animate({
                ...
                backgroundSize: "50%"
            }, 50 * t == "0" ? "100" : 50 * t), $(e).find("span").eq(s).text(videoTools.excutenum())
        }
    }, 100), n = $(".codeboxl .perspectiveView");
    $(n).each(function (o) {
        videoTools.xz3D(n[o], !1)
    }), $(".oping").show(), $(".djs").hide(), animateID[o] = e
}, animate.sscAnimateEnd = function (o, e, n, s, t) {
    videoTools.ifsund() && ($("#bgsound").attr("src", "sound/over.mp3"), videoTools.sounds.soundsT.play("bgsound")), clearInterval(animateID[e]);
    var i = $(e).find(".box");
    $(".oping").hide(), $(".djs").show();
    var a = [];
    $(i).each(function (e) {
        $(this).find("span").text(""), "10060" == lotCodestr ? $(this).find("span").removeClass().addClass("cznum" + o[e]) : $(this).find("span").removeClass().addClass("num" + o[e]), a.push($(this).find("span"))
    }), videoTools.showNUM(a, o), s || videoTools.cutTime(n, t)
    ...
    for (var n = $(".tl .perspectiveView"), s = $(".bl .perspectiveView"), t = function (o) {
        ...
        setTimeout(function () {
            t(o[d]), videoTools.xz3D(n[d], !0), videoTools.xz3D(s[d], !0), d++
        }, a)
    }
    setTimeout(function () {
...
}, videoTools.cutTime = function (o, e) {
    var n = o;
    var isss = parseInt($("#drawIssue").val());
    clearInterval(animateID.timer), timerInterval = window.setInterval(function () {
        if (n >= 1) {
            n -= 1;
            var o = Math.floor(n / 3600), s = Math.floor(n / 60 % 60), t = Math.floor(n % 60), i = "";
            i = (i = o <= 0 ? "" : (o < 10 ? "0" + o : o) + ":") + "" + (s < 10 ? "0" + s : s) + ":" + (t < 10 ? "0" + t : t), $(".bluefont").text(i)
        } else clearInterval(timerInterval), setTimeout(pubmethod.doAjax(isss, e.lotCode, e.type, !1), "1000"), animate.sscAnimate("#numBig", e)
