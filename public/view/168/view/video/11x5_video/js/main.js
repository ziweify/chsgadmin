...
var k3v = {}, tryflag = !0, timer = null, audioType = "b", firth11Load = !0, ifopen = !0, animateId = {}, dataStr = {
...
k3v.btnStyle = function () {
    ...
    timer = setInterval(function () {
        var isss = parseInt($("#drawIssue").text());
        if (e >= 1) {
            e -= 1;
        ...
        } else $(".noinfor").text("正在开奖，禁止模拟"), clearInterval(timer), k3v.playGame(), console.log(n), setTimeout(pubmethod.doAjax(isss, n.lotCode, n.type, !1), "500")
    }, 1e3)
}, k3v.clearTime = function () {
    clearInterval(timer)
}, k3v.startVideo = function (e, n) {
    k3v.sound.stop("audioidB"), audioType = "r", k3v.updateData(e), console.log(e.preDrawCode.split(",")), k3v.stopGame(e.preDrawCode.split(","), "2"), k3v.cutTime(k3v.getSecond(e.drawTime, e.serverTime), n), setTimeout(function () {
    ...
    return sys_second = addTime(e) - addTime(n), console.log(sys_second), sys_second
}, k3v.sound = {
    play: function (e) {
    ...
    k3v.stopGame(e.preDrawCode.split(","), 1), setTimeout(function () {
        k3v.cutTime(k3v.getSecond(e.drawTime, e.serverTime), n), tryflag = !0
