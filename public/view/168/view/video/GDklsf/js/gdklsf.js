...
fun.moveBall = function () {
    ...
    addint = setInterval(function () {
        ...
        n && (u += o), $(".result_box>ul").append(o), ++i >= t && (interInt = !1, clearInterval(addint)), setTimeout(function () {
...
fun.cutTime = function (e, n) {
    console.log(e), null != timer && clearInterval(timer);
    var e = e;
    timer = setInterval(function () {
        if (e >= 1) {
            e -= 1;
            var t = Math.floor(e / 3600), u = Math.floor(e / 60 % 60), i = Math.floor(e % 60), l = "";
            if (l = (t < 10 ? "0" + t : t) + ":", l = l + "" + (u < 10 ? "0" + u : u) + ":" + (i < 10 ? "0" + i : i), $(".Time_box").text(l), e < 10) {
                var o = $(".linelist").find("li");
                $(o).eq(e).addClass("redli")
            }
        } else clearInterval(timer), $(".Time_box").hide(), $(".opening").show(), fun.moveBall(), setTimeout(pubmethod.doAjax($("#nextIssue").text(), n.lotCode, n.type, !1), "500")
    }, 1e3)
    ...
    if (void 0 != i && (clearInterval(addint), clearTimeout(fillTime)), $(".result_box>ul").html(""), $(".Time_box").show(), $(".opening").hide(), $("#nextIssue").html(n), $("#nextOpTime").html(t), $("#thisIss").html(e), fun.cutTime(u, l), fun.ballStatic(), void 0 != i) {
        for (var o = "blue", a = "", r = 0; r < i.length; r++) o = 19 == i[r] || 20 == i[r] ? "red" : "blue", i[r] < 10 ? i[r] = "0" + i[r] : i[r], a += "<li class='ball " + o + "'>" + i[r] + "</li>";
    ...
    if ($(".Time_box").hide(), $(".opening").show(), $("#nextIssue").html(n), $("#nextOpTime").html(t), $("#thisIss").html(e), void 0 != u) {
        for (var i = "blue", l = "", o = 0; o < u.length; o++) i = 19 == u[o] || 20 == u[o] ? "red" : "blue", u[o] < 10 ? u[o] = "0" + u[o] : u[o], l += "<li class='ball " + i + "'>" + u[o] + "</li>";
