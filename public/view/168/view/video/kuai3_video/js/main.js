...
k3v.startGame = function (t) {
    ...
    e.codePlay = function () {
        ...
        animateId[n] = i
    }, t && e.codePlay(), $(".linelist").find("li").addClass("redli"), ifpaused = "audioidB", $("#spanbtn").hasClass("sounds") && k3v.sound.play("audioidR"), k3v.bressBG(10)
...
k3v.tryPlay = function () {
    ...
    if (tryflag) {
        ...
        var e = setTimeout(function () {
            ...
            var a = setTimeout(function () {
                ...
                k3v.cutTime(i), ifpaused = "audioidB", $("#spanbtn").hasClass("sounds") && k3v.sound.play("audioidB"), k3v.bressBG()
            }, 2e3);
    ...
    $(".nowDraw").text(n);
    if (void 0 != t.drawTime) a = t.drawTime.substr(t.drawTime.length - 8, 8); else var a = "";
    $("#drawTime").text(a)
}, k3v.cutTime = function (t, e) {
    null != timer && clearInterval(timer);
    var t = t;
    timer = setInterval(function () {
        var drawIssue = $("#drawIssue").text();
        if (t >= 1) {
            t -= 1;
            var n = Math.floor(t / 3600), a = Math.floor(t / 60 % 60), i = Math.floor(t % 60), s = "";
        ...
        } else $(".noinfor").text("正在开奖，禁止模拟"), clearInterval(timer), k3v.playGame(), $("#timetitle").text("正在开奖"), $("#hourtxt").hide(), $("#opening").show(), setTimeout(pubmethod.doAjax(drawIssue, e.lotCode, e.type, !1), "500")
    }, 1e3)
}, k3v.sound = {
    play: function (t) {
...
}, k3v.stopVideo = function (t, e) {
    k3v.stopGame(t.preDrawCode), k3v.updateData(t), setTimeout(function () {
        $("#timetitle").text("倒计时"), $("#hourtxt").fadeIn(), $("#opening").hide(), $(".linelist").find("li").removeClass("redli"), k3v.cutTime(t.seconds, e), ifpaused = "audioidB", $("#spanbtn").hasClass("sounds") && k3v.sound.play("audioidB"), k3v.bressBG(), tryflag = !0
    }, 2e3)
