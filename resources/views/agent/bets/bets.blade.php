...
<head>
    ...
    <title>下注明细</title>
    <link href="/xypone/138/js/jquery/new/jquery-ui.css" rel="stylesheet" type="text/css"/>
    <link href="/xypone/138/static/default/css/agent/red/master.css" rel="stylesheet" type="text/css"/>
    <link href="/xypone/138/static/default/css/agent/red/layout.css" rel="stylesheet" type="text/css"/>
    <link href="/xypone/138/static/default/css/sweetalert.css" rel="stylesheet" type="text/css"/>
    <link href="/xypone/138/static/default/css/loading.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="/xypone/138/js/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="/xypone/138/js/jquery-ui.js"></script>
    <script type="text/javascript" src="/xypone/138/js/jquery.ui.datepicker-zh-CN.js"></script>
    <script type="text/javascript" src="/xypone/138/js/libs.js"></script>
    <script type="text/javascript" src="/xypone/138/js/json2.js"></script>
    <script type="text/javascript" src="/xypone/138/static/default/js/sweetalert.min.js"></script>
    <script>
    ...
    <link href="/xypone/138/static/default/css/agent/bets.css" rel="stylesheet" type="text/css"/>
    <link href="/xypone/138/static/default/css/betExtra.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="/xypone/138/static/default/js/bets.js"></script>
    <script type="text/javascript">var url = 'report/shares';</script>
    <script type="text/javascript" src="/xypone/138/static/default/js/betExtra.js"></script>
</head>
<body>
<div class="main">
    <div class="top_info">
    ...
    <div class="contents">
        <table class="data_table list">
            ...
            <tr>
                <td>
                    <a href='javascript:queryBetExtraDetail("sss666", "20221124220827350581880001", "SGFT","2022-11-24 00:00:00")'>{{$vo['code']}}#</a> </span>
                </td>
                ...
                <td><span class="drawNumber1">{{$vo['wf']}}</span> @ <span class="odds">{{$vo['peilv1']}}</span>
                </td>
...
<script>
    ...
    $(".page a").click(function() {
        ...
        window.location.href = "/stsa/bets?gid={$gid}&qishu={$qishu}&page=" + page;
    })
</script>
</html>
