    ...
    <div class="panel">
        <div class="login">
            ...
            <form action="login" method="post">
                ...
                <div class="info code"><label>验证码</label><input type="text" name="code" autocomplete="off" title="验证码"><img src="code?_=1682237467470" alt="none" title="看不清？点击更换一张验证图片" /></div>
