...
<head>
    ...
    <script type="text/javascript" src="/static/default/js/member.js?v=160520"></script>
    ...
    <script type="text/javascript">
        ...
        alert('{{$alertmsg}}');
        @endif
        LIBS.cookie('oid', '1f08ecc5733978e267c6225e7133417944123dd8');
...
<body>
<input type="hidden" id="currentLoginUser" value="ws008-{{$username}}"/>
