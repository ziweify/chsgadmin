...
<div class="main password">
    <table class="table user_info pass_panel input_panel">
        ...
        <form>
            ...
            <tr>
                <th>新密码</th>
                <td><input id="password" type="password"/>＊6-20字符必须由大小写字母和数字组合组成</td>
            </tr>
            <tr>
                <th>确认密码</th>
                <td><input id="ckPassword" type="password"/></td>
            </tr>
            </tbody>
    </table>
    <div class="control"><input type="button" class="button" value="确定" onclick="changePassword()"/> <input
            type="reset" class="button" value="重置"/></div>
    </form>
</div>
</body>
</html>
