...
<link rel="stylesheet" type="text/css" href="/static/default/css/agreement.css" />
@if($status == 1)
<script type="text/javascript">alert('抱歉!你的帐号已被冻结（只限结帐功能可用），请和上级联系。');</script>
@endif
<body>
<div class="user_win">
	<div class="agree_win">
            ...
            <li class="user_winmain">
            	<div class="win_info">
                	<ul>
                        ...
                        <li>以上协议解释权归本系统所有。</li>
                        <li class="user_winbu"><div><span><a class="no" href="/logout?id=c857d50f158475e7a88240465ad52f47">不同意</a><a class="yes" href="index">同意</a></span></div></li>
                	</ul>
            	</div>
            </li>
