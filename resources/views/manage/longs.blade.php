...
<html xmlns="http://www.w3.org/1999/xhtml" @if($rkey==0)oncontextmenu="return false" @endif>
	<head>
		...
		<link href="/xypone/css/default/result.css?v=1" rel="stylesheet" type="text/css">
        @if($gid==101)
		...
		@else
		<link href="/xypone/css/default/{{$fenlei}}.css?v=122" rel="stylesheet" type="text/css">
		@endif
		<script language="javascript" src="/xypone/default/js/default/jshide/longsmyadmin.js?v=11111"></script>
		<style type="text/css">
			.list td.he {
						...
						<tr>
							...
							<td class="name ballname">
                                ...
                                <span class="b{{substr($k,0,2)}}">{{substr($k,0,2)}}</span>
                                    @if($fenlei==100)
                                        <label class="sxs">{{substr($k,3)}}</label>
                                    @endif
                                @endif
                            </td>
							@endforeach
