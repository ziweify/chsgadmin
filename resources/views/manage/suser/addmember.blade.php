	...
	<tbody>
		<TR>
			...
			<TD><label>{{$fname}}</label><input type="hidden" value="adduser" name='xtype' id='xtype' /><input
					type="hidden" value="" name='action' id='action' /></td>
		</TR>
		<tr>
			<th>会员帐号：</th>
			<TD>
		...
		<TR style="display: none;">
			<th>限制赢利金额：</th>
			<TD><input type="text" name='yingdeny' id='yingdeny' class="input" value='' />&nbsp;&nbsp;设0为不限制
			</td>
		</tr>
		<TR>
			<th>登入密码：</th>
		...
		<tr class='hides'>
			<th>&nbsp;</th>
			<TD><input type="button" class="btn1 btnf add" value="新增{{$layername}}" style="margin-right:20px;" /><input
					type="button" class="btn1 btnf close" value="关闭窗口" /></td>
		</tr>
		<TR class='hides'>
			<Td colspan="2">
