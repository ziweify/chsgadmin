...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" src="/xypone/default/js/default/jshide/baonewmyadmin.js?v=1111"></script>
	...
	<body>
		<div class="main">
            <div class="top_info">
                <span class="title">公司({{$username}}）报表查询</span>
				...
				<table class="data_table list report">
					...
					<thead>
						...
						<tr class="shead">
                            ...
                            <th class="tax" style="color:red;font-weight: bold">
                                赚点
                            </th>
							<th class="plc">
								赚赔
				...
				<table class="data_table list report">
					...
					<thead>
						<tr class="shead">
							...
							<th rowspan="2" class="ups">上交货量</th>
							<th rowspan="2" data-sort="number" class="ups sortable ca">上级交收<i></i></th>
						</tr>
						<tr class="shead">
							<th>输赢</th>
							<th>退水</th>
				...
				<table class="data_table list report">
					...
					<tfoot>
						<tr>
							...
							<td class="result color ff"></td>
							<td class="ups"></td>
							<td class="ups result color ff"></td>
						</tr>
					</tfoot>
				</table>
			</div>
		...
		<div class="main3 gdiv" style="display:none">
			...
			<div class="contents">
				<table class="data_table list report" data-colspan="6">
					...
					<thead>
						<tr class="shead">
							<th rowspan="2" data-sort="string" data-sort-dir="asc"
								class="sortable sortdefault sorting-desc">
								日期<i></i>
							</th>
							<th rowspan="2">
								级别
