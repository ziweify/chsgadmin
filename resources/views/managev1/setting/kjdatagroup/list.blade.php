...
<head>
    ...
    <script type="text/javascript" src="/default/js/kjwkjdatagroup.js?v2231"></script>
    ...
    <div class="top_info">
        ...
        <div class="center">
            <div class="query_panel">
                ...
                <button type="button" class="query" onclick="clearall(1)">清理所有数据</button>
                ...
                <button type="button" class="query" onclick="yijianjiesuan()">一键结算</button>
            </div>
        </div>
        <div class="right">
