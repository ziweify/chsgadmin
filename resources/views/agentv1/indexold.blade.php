@php use phpDocumentor\Reflection\Types\This; @endphp
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
    "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
    <link rel="icon" type="image/x-icon" href="//imgsg88.com/general/generic_favicon.ico"/>
    <title>Welcome</title>
    ...
    <script type="text/javascript" src="/default/js/agent.js?v=1"></script>
...
<div class="header">
    <div class="top" style="position:relative">
        ...
        <div class="menu">
            ...
            <ul class="menu_title">
                <li>
                    @if(in_array('control',$auths) && $status==0)<a href="javascript:;" class="control">即时注单</a>@endif
                    @if(in_array('betback',$auths) && $flytypecount > 0 && $status==0)<a href="javascript:;">自动补货</a>@endif
                    @if(in_array('user.children',$auths) && $status==0)<a href="javascript:;">用户管理</a>@endif
                    @if($status==0)<a href="javascript:;">个人管理</a>@endif
                    @if(in_array('agent.follow',$auths) && $planenable==1 && $status==0)<a href="javascript:;">跟投</a>@endif
                    @if($outbet_status==1 && $status==0 && $plat_outbet_status==1)<a href="javascript:;">{{$outbet_name}}</a>@endif
                    @if(in_array('sys.odds',$auths) && $ifexe == 1 && $status==0)<a href="javascript:;">系统管理</a>@endif
                    @if(in_array('report.list',$auths) || in_array('report.logs',$auths) && $status==0)<a href="report/main" target="frame">报表查询</a>@endif
        ...
        <ul class="tools">
            ...
            <li class="tools_user" style="width:66%">在线会员：<span id="online"> 网页端：0 + APP：0总在线：0</span><br>{{$layername}}：{{$username}}</li>
        </ul>
    </div>
    ...
    @if(in_array('control',$auths))<ul class="menu_sub">
    ...
    @if(in_array('betback',$auths) && $flytypecount > 0)<ul class="menu_sub">
        <li class="menu_sub_title">当前选中：<span>自动补货</span></li>
        <li class="menu_sub_link">
            <a href="user/backshare" target="frame">自动补货设定</a> |
            <a href="logs?type=autoback" target="frame">自动补货变更记录</a>
        </li>
    </ul>@endif
    @if(in_array('user.children',$auths))<ul class="menu_sub">
    ...
    <ul class="menu_sub">
        ...
        <li class="menu_sub_link">
            ...
            <a href="tax/list" target="frame" class="">{{$tax_name}}设置</a> |
            <a href="tax/templates" target="frame" class="">{{$tax_name}}模板</a> |
            @endif
        </li>
    </ul>
    @if(in_array('agent.follow',$auths) && $planenable==1)<ul class="menu_sub">
    ...
    @endif
    @if(in_array('sys.odds',$auths) && $ifexe == 1)<ul class="menu_sub">
