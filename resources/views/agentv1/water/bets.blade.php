...
<div class="main tax_bets">
    <div class="top_info">
        <span class="title">注单明细<button id="resetBetButton">恢复注单{{$water_name}}</button></span>
    </div>
    <div class="contents">
        <table class="data_table list">
            ...
            <tr>
               ...
               {{-- <td class="money color">@if($settle == 'true'){{$vo['mers']}}@else @endif</td>--}}
                <td class="money">{{$vo['water']}} ({{$vo['uzp']}}%)</td>
            ...
            <tr>
                ...
                <td class="money">@if($settle == 'true'){{$total['bjwater']}}@endif</td>
                <td></td>
            </tr>
            </tfoot>
        </table>
