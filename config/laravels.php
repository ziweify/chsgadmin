...
return [
    ...
    */
    ...
    'websocket' => [
        'enable' => true,
        'handler' => \App\Services\ChatService::class,
    ],
    ...
    */
    ...
    'timer' => [
        ...
        'jobs' => [
            ...
            App\Common\Task\TaskKj::class,
            App\Common\Task\TaskCommon::class,
            App\Common\Task\TaskFastData::class,
            App\Common\Task\TaskOutbet::class,
            /*App\Common\Task\TaskRunOubet::class,*/
            /*App\Jobs\Timer\WebsocketCheckOnline::class,*/
        ],
    ...
    */
    ...
    'swoole_tables' => [
        // 场景：WebSocket中UserId与FD绑定1
        /*'ws' => [// Key为Table名称，使用时会自动添加Table后缀，避免重名。这里定义名为wsTable的Table
            'size'   => 20480,//Table的最大行数
            'column' => [// Table的列定义
                ['name' => 'fd', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 50],
                ['name' => 'uid', 'type' => \Swoole\Table::TYPE_INT],
                ['name' => 'type', 'type' => \Swoole\Table::TYPE_INT],
                ['name' => 'ruid', 'type' => \Swoole\Table::TYPE_INT],
            ],
        ]*/
    ],
    ...
    */
    ...
    'swoole' => [
        ...
        'task_ipc_mode' => 1,
        'task_max_request' => env('LARAVELS_TASK_MAX_REQUEST', 3000),
